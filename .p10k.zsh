# Generated by Powerlevel10k configuration wizard on 2019-11-26 at 10:07 PST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 46685.
# Wizard options: nerdfont-complete + powerline, large icons, classic, light, time,
# vertical separators, blurred heads, blurred tails, 2 lines, solid, left frame, sparse,
# few icons, concise.
