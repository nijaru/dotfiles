...
- 2026-04-26 closeout: external 3090 report reinforces the same baseline, not a change request. Keep `llm-serve` on llama.cpp + Unsloth GGUF + OpenAI-compatible port 8080 for local agents; only revisit `Q4_K_M`, DFlash, or vLLM as separate experiments with long-prompt/tool-call validation.
