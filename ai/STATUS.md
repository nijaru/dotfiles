...
- `llm-serve` is a fish/Nushell function wrapping `hf download` + `llama-server`; bare `llm-serve` prints help. `llm-serve unc ...` or `llm-serve --unc ...` selects the HauhauCS Aggressive uncensored secondary model.
