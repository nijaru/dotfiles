...
| Codex CLI | direct symlinks into `~/.codex/skills/` for shared skills | `private_dot_codex/skills/` |
...
- Keep Codex on per-skill symlinks until it exposes a first-class shared-skills path.
