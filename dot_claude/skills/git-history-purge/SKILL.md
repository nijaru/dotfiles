...
description: Use to surgically purge sensitive data (secrets, large files, private docs) from the entire git history. This skill enforces a "Gold Standard" workflow that re-signs all rewritten commits and force-syncs committer dates to original author dates.
---
