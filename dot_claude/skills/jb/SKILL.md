---
name: jb
description: Use for managing long-running background tasks, preventing shell blocking, and monitoring async operations.
...
- **Don't Block:** Use `jb run` for any task expected to take > 30 seconds (full builds, exhaustive tests, dependency sync).
