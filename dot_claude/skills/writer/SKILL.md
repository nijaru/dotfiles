---
name: writer
description: Use when reviewing or revising text (prose, docs, commits) to remove AI patterns and improve voice/clarity.
...
2. **Sentences:** Vary length. Cut "filter words" (I think, I believe).
3. **Words:** Replace Latinate bloat (utilize -> use). Flag AI red flags.
4. **Voice:** Ensure it sounds like a person, not a template. Add opinion/mess.

### AI Red Flags (Prohibited)
- **Transitions:** Additionally, Furthermore, Moreover.
- **Verbs:** Showcase, leverage, harness, foster, underscore.
...
| "The user won't notice" | Readers subconsciously reject algorithmic-sounding prose. |
