...
| Before context limit     | Update STATUS.md with current state                  |
| Session ending           | Update STATUS.md, sync beads (`bd sync`)             |
...
**Project config:** AGENTS.md primary (Codex reads this automatically)
