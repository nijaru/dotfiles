...
description: >
  ...
  Triggers on: "setup ai", "init ai", "initialize context", "new project setup".
metadata:
  short-description: Initialize AI context
---
...
- "setup ai", "init ai context", "initialize context"
- "new project setup", "set up ai directory"
